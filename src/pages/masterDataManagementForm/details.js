...
const MdmDetails = () => {
  ...
  return (
    <DefaultLayout>
      <Row gutter={[24, 24]}>
        <Col span={24}>
          <Header icon={<FormOutlined />} title="MDM Details" />
        </Col>
      </Row>
                  ...
                  <>
                    <Card title="Basic Information" className="mb-10">
                      <Row gutter={[16, 16]}>
                        ...
                        {data && data.mdm_category?.name && (
                        <Col xs={24} sm={12} md={8} lg={6} xl={6}>
                          <p className="fs-12 mb-10">MDM Category</p>
                          <Tag>{data.mdm_category?.name}</Tag>
                        </Col>
                        )}
                        {data && data.project_MDM && (
                        <Col xs={24} sm={12} md={8} lg={6} xl={6}>
                          <p className="fs-12 mb-10">Project Name</p>
                          <Tag>{data.project_MDM?.name}</Tag>
                        </Col>
                        )}
